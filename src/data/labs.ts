...
export const LABS: Lab[] = [
  {
    ...
    outcome: ['Ambiente altamente resiliente com failover funcional \nSegmentação eficiente aumentando a segurança da rede \nImplementação prática de VRRP com comportamento customizado \nEvolução de tecnologias (migração de L2TP para WireGuard) \nValidação de segurança através de testes reais de acesso externo \nForte ganho de experiência em troubleshooting e lógica de redes'],
    repoLink: '',
    notes: 'Este laboratório foi desenvolvido com foco no entendimento prático do funcionamento de redes corporativas utilizando MikroTik, com ênfase em redundância, segmentação e segurança. \n\nA topologia consiste em dois links de internet distintos: um link dedicado com IP público e um link PPPoE, permitindo simular cenários reais de múltiplos provedores. A redundância é garantida através de switches operando em bridge com separação por VLAN, evitando falhas únicas na camada de transporte. \n\nO núcleo da rede é composto por dois firewalls configurados com VRRP, inicialmente em modo Active/Passive. No entanto, foram implementados scripts personalizados que permitem, em determinados cenários, a operação em Active/Active, aumentando a eficiência e utilização dos recursos. \n\nA rede é segmentada por um Core Layer 3 utilizando VLANs (10, 20, 30, 40, 50), garantindo isolamento entre departamentos e melhor organização do tráfego. Regras específicas de firewall foram aplicadas principalmente para redes críticas, como TI e Financeiro. \n\nUma DMZ foi implementada para isolamento de serviços, reforçando a segurança da rede interna. \n\nAlém disso, o ambiente inclui uma filial simulada para testes de VPN, inicialmente utilizando L2TP e posteriormente migrando para WireGuard, devido à sua superioridade em desempenho e segurança. \n\nPor fim, um cliente externo foi utilizado para testes de intrusão, permitindo validar regras de firewall, exposição de portas e possíveis inconsistências na configuração. \n\nO projeto foi desenvolvido ao longo de aproximadamente três semanas e representa uma base sólida de conhecimentos em redes, com possibilidade de otimizações futuras utilizando novas abordagens e tecnologias.',
